...
var ScatterPlot = function (_Component) {
  ...
  (0, _createClass3.default)(ScatterPlot, [{
    ...
    value: function renderOverlay() {
      ...
      var overlay = this.svg.append('rect').attr('width', width).attr('height', height).attr('class', 'overlay').style('fill', 'none').style('pointer-events', 'all').on('mousemove', function () {
